// D&D 5e Conditions reference data
...
export const DND_CONDITIONS: Condition[] = [
  ...
  },
  {
    name: "Exhaustion",
    description:
      "Some special abilities and environmental hazards, such as starvation and the long-term effects of freezing or scorching temperatures, can lead to a special condition called exhaustion. Exhaustion is measured in six levels.",
  },
  {
    name: "Frightened",
    description:
...
export function getCondition(name: string): Condition | undefined {
  return DND_CONDITIONS.find((c) => c.name.toLowerCase() === name.toLowerCase());
}
